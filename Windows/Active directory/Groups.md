...
| **DNS Admins**                  | Can load malicious DLLs into DNS service (though unreliable). Better exploited by creating a [WPAD record](https://web.archive.org/web/20230129100526/https://cube0x0.github.io/Pocing-Beyond-DA/) for credential capture or persistence. |
